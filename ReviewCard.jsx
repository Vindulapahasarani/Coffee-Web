...
const ReviewCard = (props) => {
  return (
    <div className=" flex flex-col w-full lg:w-2/6 bg-white p-3 rounded-lg gap-5">
      ...
      <p>
      "Absolutely love this café! The aroma of freshly brewed coffee fills the air, creating the perfect cozy atmosphere. The cappuccino was smooth, rich, and perfectly balanced. The staff was warm and welcoming—definitely my new favorite spot!"
      </p>
    </div>
  );
};
